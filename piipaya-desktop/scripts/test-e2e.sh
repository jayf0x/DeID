...
bun run dev:web --host "$HOST" --port "$PORT" >/tmp/piipaya-wdio-dev.log 2>&1 &
VITE_PID=$!
...
PIIPAYA_OLLAMA_MODEL="$OLLAMA_MODEL" PIIPAYA_RUN_OLLAMA_E2E="$RUN_OLLAMA_E2E" bunx wdio run wdio.conf.js
