<script lang="ts">
  ...
  import logoDark from "$lib/assets/logo-black.png";
  import logoLight from "$lib/assets/logo-white.png";
...
<aside class:collapsed>
  ...
  <div class="sidebar-top">
    {#if !collapsed}
      <img class="logo" src={activeTheme =='dark' ? logoDark : logoLight} alt="PIIPAYA" />
    {/if}
